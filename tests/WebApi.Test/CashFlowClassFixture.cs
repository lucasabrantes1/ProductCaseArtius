...
public class ProductCaseArtiusClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public ProductCaseArtiusClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
